...
{detail&&<aside className="monitor-detail"><header><h3><Localized text={"Detay tikè"}/></h3><Button variant="ghost" aria-label="Fèmen detay tikè" onClick={()=>{setSelected(null);setConfirm(false)}}>×</Button></header><h4>{detail.id}</h4><p>{statusName(detail)}</p>
