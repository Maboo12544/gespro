...
export function DashboardReport({tickets,onCancel,serverBacked=false,canCancel=true}:{serverBacked?:boolean;canCancel?:boolean;tickets:MonitoredTicket[];onCancel:(id:string)=>boolean|Promise<boolean>}){
 ...
 <section className="panel sales-control-filter"><h2>Kontwòl lavant</h2><p className="monitor-demo">{serverBacked?"Mòd tès • Tikè sou sèvè a, selon bank ak POS kont ou ka wè. Pa gen peman reyèl.":"Mòd tès • Tikè navigatè sa a sèlman. Lavant lòt aparèy yo poko senkronize."}</p>
